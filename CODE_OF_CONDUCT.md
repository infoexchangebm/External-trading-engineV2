...
the Algo Signal Engine / External Trading Engine project a harassment-free
...
reported to the maintainers via the process described in
[`SECURITY.md`](SECURITY.md) for sensitive matters, or by opening a GitHub
